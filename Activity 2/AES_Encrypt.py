...
print("* encoding the encrypted data to base64 before decoding to utf-8...")
ct_username = b64encode(encrypted_username).decode('utf-8')
ct_password = b64encode(encrypted_password).decode('utf-8')

# get the initialization vector
print("* getting the initialization vector...")
iv = b64encode(cipher.iv).decode('utf-8')

# print the encrypted data
print('=' * 50)
print(f"Encrypted Username: {ct_username}")
print(f"Encrypted Password: {ct_password}")
...
print("* decoding the base64 encoded ciphertexts...")
...
print('=' * 50)
print(f"Decrypted Username: {pt_username}")
print(f"Decrypted Password: {pt_password}")
